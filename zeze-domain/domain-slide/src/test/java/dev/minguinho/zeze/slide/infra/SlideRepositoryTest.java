...
public class SlideRepositoryTest {
    ...
    void save() {
        ...
        String content = "내용";
        Slide slide = new Slide(title, subtitle, author, presentedAt, content, Slide.AccessLevel.PUBLIC, 1L);
    ...
    void update() {
        ...
        Slide request = new Slide(newTitle, subtitle, author, presentedAt, content, Slide.AccessLevel.PUBLIC);
        ...
        assertAll(
            ...
            () -> assertThat(newSlide.getAccessLevel()).isEqualTo(Slide.AccessLevel.PUBLIC)
        );
    }
