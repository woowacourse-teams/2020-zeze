package dev.minguinho.zeze.auth.service.socialfetcher.accesstokenfetcher.dto.response;
...
import dev.minguinho.zeze.auth.service.socialfetcher.resourcefetcher.dto.request.GithubResourceRequestDto;
...
public class GithubAccessTokenResponseDto implements SocialAccessTokenResponse {
    ...
    @Builder
    private GithubAccessTokenResponseDto(String accessToken) {
